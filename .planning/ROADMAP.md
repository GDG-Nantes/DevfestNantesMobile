...
- [ ] 02-01-PLAN.md — Version-target policy decision, then the Kotlin 2.4.x + KSP tracer: catalog → local build → both CI workflows green → app on device (BUILD-01, D-01, D-02, D-03)

**Wave 2** *(blocked on Wave 1)*

- [ ] 02-02-PLAN.md — Gradle 9.7.1 wrapper with distribution checksum, then AGP 9 `com.android.kotlin.multiplatform.library` swap plus the forced Detekt/Hilt/Firebase-perf bumps and the packaging DSL fix (BUILD-02, BUILD-03, D-04, D-05)

**Wave 3** *(blocked on Wave 2)*

- [ ] 02-03-PLAN.md — Compose BOM 2026.08.00, then Apollo 5.x with the `com.apollographql.cache` artifact-group migration and its compiler plugin (BUILD-04, BUILD-05, D-06, D-07)
...
| 2. Dependency & Build Tooling Upgrade | 0/5 | Planned | - |
